...
@section('content')
<div ng-controller="PostsEditCtrl" ng-cloak>
        ...
        <div class="card shadow mb-3">
            ...
            <div class="card-body">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="mt-1">
                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                        <input type="checkbox" class="custom-control-input" id="isFeaturedEdit" ng-model="model.is_featured">
                                                        <label class="custom-control-label small" for="isFeaturedEdit">Nổi bật</label>
                                                    </div>
                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                        <input type="checkbox" class="custom-control-input" id="showTocEdit" ng-model="model.show_toc">
                                                        <label class="custom-control-label small" for="showTocEdit">Mục lục</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div ng-repeat="lang in languages" ng-show="activeTab === lang.code">
                    ...
                    <div class="alert alert-info py-2 mb-3">
                        ...
                        <strong>Đang chỉnh sửa nội dung:</strong>
            ...
            <div class="border-top pt-3 mt-4 mb-3 mr-3 text-right">
                ...
                <button class="btn btn-primary ml-2" type="button" ng-click="save()" ng-disabled="saving">
                    <i class="fas fa-save"></i> @{{ saving ? 'Đang lưu…' : 'Cập nhật' }}
                </button>
            </div>
        </div>
    </div>
    ...
    <script>
        var pageData = {
            'data': <?php echo $data ?>,
            'listUrl': '<?php echo route('admin.posts') ?>'
        };
    </script>
    @vite('resources/js/admin/pages/posts/postsEditCtrl.js')
    <script>
